...
def set_config(dbutils, catalog='default', schema=None):
    ...
    config = {
        ...
        'list_price_table': f'{catalog}.{schema}.list_price',
        'maintenance_table': f'{catalog}.{schema}.maintenance_price',
        'feature_table': f'{catalog}.{schema}.features',
        'predictions_table': f'{catalog}.{schema}.predictions',
        'model_name' : f'device_defect_classifier',
        'agent_model_name' : f'{catalog}.{schema}.customer_service_agent',
        'vs_endpoint' : 'one-env-shared-endpoint-1',
        'docs_table' : f'{catalog}.{schema}.customer_service_docs'
    }
...
dgconfig = {
    "shared": {
        "num_rows": random.randint(3500000, 4500000),
        "num_devices": random.randint(450, 550),
