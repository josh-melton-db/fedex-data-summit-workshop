...
def create_initial_df(spark, num_rows, num_devices, **kwargs):
    factory_ls = ["'A06'", "'D18'", "'J15'", "'C04'", "'T10'"] # Frequencies for models
    model_ls = [item for sublist in [["'SkyJet134'"]*5, ["'SkyJet234'"]*3, ["'SkyJet334'"]*2, ["'EcoJet1000'"]*2, 
                                     ["'EcoJet2000'"]*3, ["'EcoJet3000'"], ["'FlyForceX500'"], ["'FlyForceX550'"]*3, 
                                     ["'SkyBolt1'"]*3, ["'SkyBolt2'"]*2, ["'SkyBolt250'"],
                                     ["'AeroWing1100'"], ["'AeroWing2200'"]*2, ["'AeroWing4150'"]*4] for item in sublist]
    return (
...
def land_financials(spark, config):
    list_prices_data = [
        Row(model_id="SkyJet134", list_price=200000),
        Row(model_id="SkyJet234", list_price=300000),
        Row(model_id="SkyJet334", list_price=410000),
        Row(model_id="EcoJet1000", list_price=151000),
        Row(model_id="EcoJet2000", list_price=178000),
        Row(model_id="EcoJet3000", list_price=191000),
        Row(model_id="SkyBolt1", list_price=239000),
        Row(model_id="SkyBolt2", list_price=389000),
        Row(model_id="SkyBolt250", list_price=519000),
        Row(model_id="FlyForceX500", list_price=259000),
        Row(model_id="FlyForceX550", list_price=1100000),
        Row(model_id="AeroWing1100", list_price=299000),
        Row(model_id="AeroWing2200", list_price=600000),
        Row(model_id="AeroWing4150", list_price=180000)
    ]
    maintenance_prices_data = [
        Row(model_id="SkyJet134", repair_price=3000),
        Row(model_id="SkyJet234", repair_price=8100),
        Row(model_id="SkyJet334", repair_price=9200),
        Row(model_id="EcoJet1000", repair_price=3510),
        Row(model_id="EcoJet2000", repair_price=2780),
        Row(model_id="EcoJet3000", repair_price=2610),
        Row(model_id="SkyBolt1", repair_price=2750),
        Row(model_id="SkyBolt2", repair_price=2500),
        Row(model_id="SkyBolt250", repair_price=1100),
        Row(model_id="FlyForceX500", repair_price=1000),
        Row(model_id="FlyForceX550", repair_price=7000),
        Row(model_id="AeroWing1100", repair_price=3999),
        Row(model_id="AeroWing2200", repair_price=6100),
        Row(model_id="AeroWing4150", repair_price=3200)
    ]
    spark.createDataFrame(list_prices_data).write.mode('overwrite').saveAsTable(config['list_price_table'])
    spark.createDataFrame(maintenance_prices_data).write.mode('overwrite').saveAsTable(config['maintenance_table'])
